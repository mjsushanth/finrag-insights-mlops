...
-- 2. Temporal bins - 15/20/65 weighting (2006-2009, 2010-2015, 2016-2020)
...
SET VARIABLE priority_bin = 'bin_2016_2020';
...
SELECT 
    getvariable('company_table_name') as company_table,
    CAST(getvariable('target_sample_size') AS INTEGER) as sample_size_n,
    ...
    getvariable('sample_version_id') as sample_version,
...
stratum_sample_sizes AS (
    ...
    SELECT 
        ...
        rn_within_stratum,
        CASE 
            WHEN bin_target >= bin_population THEN stratum_size  -- Take 100% of stratum
...
SET 
    section_priority = CASE section
        WHEN 0 THEN 'P2_HEADER'
        WHEN 1 THEN 'P1_BUSINESS'
        WHEN 7 THEN 'P1_MDNA'
        WHEN 8 THEN 'P1_FINANCIALS'
        WHEN 10 THEN 'P1_NOTES'
        WHEN 19 THEN 'P3_EXHIBITS'
        ELSE 'P2_OTHER'
    END,
...
-- PERFECT FULL RUN ( i.e. entire script. )
--
